...
public class SearchActivity extends AppCompatActivity {
    ...
    private ArrayList<String> mp3Files1;    private ArrayList<String> mp3Files23;
   ...
   private int songPosition=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if(mySongs.size() ==0 && mySongs.get(0).equals("No Song Found")){
                    return;
                }

                String filePath = mp3Files.get(songPosition);
                ...
                intent.putExtra("currentIndex", songPosition);
                startActivity(intent);
            }
    ...
    private void filterSongs(String query) {
       mySongs = new ArrayList<>();
        ...
        for (int i=0; i<mp3Files1.size(); i++ ) {
            if (mp3Files1.get(i).toLowerCase().contains(query.toLowerCase())) {
